...
const AuthLayout = ({ title, children, footer }: AuthLayoutProps) => {
  return (
    <main className="relative flex min-h-screen flex-col overflow-hidden bg-black">
      {/* 背景光暈 - 依照 Figma 參數實作 */}
<<<<<<< HEAD:src/components/AuthLayout.tsx
      <div className="pointer-events-none absolute top-1/2 left-1/2 h-[522px] w-[320px] -translate-x-1/2 -translate-y-1/2 bg-[#11968D] blur-[120px] brightness-150" />
=======
...
>>>>>>> Feature-checkout-confirm-flow:src/components/auth-ui/AuthLayout.tsx
